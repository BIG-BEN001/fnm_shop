...
var ipay_checked = document.getElementById("payment_method_ipay").checked = true;
// $(document).ready(function() {
//     function check() {
//         document.getElementById("payment_method_ipay").checked = true;
//     }
// })
...
$(function() {
    ...
    $(".shipping_method").on("click", function() {
        ...
        $(".total_charge").val(removeCommas(TotalShippingfee));
    });
