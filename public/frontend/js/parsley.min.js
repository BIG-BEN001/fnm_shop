...
! function(e) {
    "use strict";
    var t = function(e) { this.messages = { defaultMessage: "This value seems to be invalid.", type: { email: "This value should be a valid email.", url: "This value should be a valid url.", urlstrict: "This value should be a valid url.", number: "This value should be a valid number.", digits: "This value should be digits.", dateIso: "This value should be a valid date (YYYY-MM-DD).", alphanum: "This value should be alphanumeric.", phone: "This value should be a valid phone number." }, notnull: "This value should not be null.", notblank: "This value should not be blank.", required: "This value is required.", regexp: "This value seems to be invalid.", min: "This value should be greater than or equal to %s.", max: "This value should be lower than or equal to %s.", range: "This value should be between %s and %s.", minlength: "This value is too short. It should have %s characters or more.", maxlength: "This value is too long. It should have %s characters or less.", rangelength: "This value length is invalid. It should be between %s and %s characters long.", mincheck: "You must select at least %s choices.", maxcheck: "You must select %s choices or less.", rangecheck: "You must select between %s and %s choices.", equalto: "This value should be the same." }, this.init(e) };
    t.prototype = {
        constructor: t,
        validators: {
            notnull: function(e) { return e.length > 0 },
            notblank: function(e) { return "string" === typeof e && "" !== e.replace(/^\s+/g, "").replace(/\s+$/g, "") },
            required: function(e) { if ("object" === typeof e) { for (var t in e) { if (this.required(e[t])) { return true } } return false } return this.notnull(e) && this.notblank(e) },
            type: function(e, t) {
                var n;
                switch (t) {
                    case "number":
            ...
            regexp: function(e, t, n) { return (new RegExp(t, n.options.regexpFlag || "")).test(e) },
            minlength: function(e, t) { return e.length >= t },
            maxlength: function(e, t) { return e.length <= t },
            rangelength: function(e, t) { return this.minlength(e, t[0]) && this.maxlength(e, t[1]) },
            min: function(e, t) { return Number(e) >= t },
            max: function(e, t) { return Number(e) <= t },
            range: function(e, t) { return e >= t[0] && e <= t[1] },
            equalto: function(t, n, r) { r.options.validateIfUnchanged = true; return t === e(n).val() },
            remote: function(t, n, r) {
                var i = null,
                    s = {},
                    o = {};
                s[r.$element.attr("name")] = t;
                if ("undefined" !== typeof r.options.remoteDatatype) { o = { dataType: r.options.remoteDatatype } }
                var u = function(t, n) {
                    if ("undefined" !== typeof n && "undefined" !== typeof r.Validator.messages.remote && n !== r.Validator.messages.remote) { e(r.ulError + " .remote").remove() }
                    r.updtConstraint({ name: "remote", valid: t }, n);
                    r.manageValidationResult()
                };
                var a = function(t) { if ("object" === typeof t) { return t } try { t = e.parseJSON(t) } catch (n) {} return t };
                var f = function(e) { return "object" === typeof e && null !== e ? "undefined" !== typeof e.error ? e.error : "undefined" !== typeof e.message ? e.message : null : null };
                e.ajax(e.extend({}, {
                    url: n,
                    data: s,
            ...
            mincheck: function(e, t) { return this.minlength(e, t) },
            maxcheck: function(e, t) { return this.maxlength(e, t) },
            rangecheck: function(e, t) { return this.rangelength(e, t) }
        },
        init: function(e) {
            var t = e.validators,
                n = e.messages;
            var r;
            for (r in t) { this.addValidator(r, t[r]) }
            for (r in n) { this.addMessage(r, n[r]) }
        },
        formatMesssage: function(e, t) { if ("object" === typeof t) { for (var n in t) { e = this.formatMesssage(e, t[n]) } return e } return "string" === typeof e ? e.replace(new RegExp("%s", "i"), t) : "" },
        addValidator: function(e, t) { this.validators[e] = t },
        addMessage: function(e, t, n) {
            if ("undefined" !== typeof n && true === n) { this.messages.type[e] = t; return }
            if ("type" === e) { for (var r in t) { this.messages.type[r] = t[r] } return }
            this.messages[e] = t
        }
    };
    var n = function(e, n, r) {
        ...
        if (r === "ParsleyFieldMultiple") { return this }
    ...
    n.prototype = {
        ...
        addConstraint: function(e, t) {
            for (var n in e) {
                ...
                if ("function" === typeof this.Validator.validators[n]) {
                    ...
                    if (n === "required") { this.isRequired = true }
                    this.addCustomConstraintMessage(n)
                }
            }
            if ("undefined" === typeof t) { this.bindValidationEvents() }
        },
        updateConstraint: function(e, t) { for (var n in e) { this.updtConstraint({ name: n, requirements: e[n], valid: null }, t) } },
        updtConstraint: function(t, n) {
            this.constraints[t.name] = e.extend(true, this.constraints[t.name], t);
            if ("string" === typeof n) { this.Validator.messages[t.name] = n }
            this.bindValidationEvents()
        },
        removeConstraint: function(e) {
            var e = e.toLowerCase();
            delete this.constraints[e];
            if (e === "required") { this.isRequired = false }
            if (!this.hasConstraints()) {
                if ("ParsleyForm" === typeof this.getParent()) { this.getParent().removeItem(this.$element); return }
                this.destroy();
                return
            }
            this.bindValidationEvents()
        },
        addCustomConstraintMessage: function(e) { var t = e + ("type" === e && "undefined" !== typeof this.options[e] ? this.options[e].charAt(0).toUpperCase() + this.options[e].substr(1) : "") + "Message"; if ("undefined" !== typeof this.options[t]) { this.Validator.addMessage("type" === e ? this.options[e] : e, this.options[t], "type" === e) } },
        bindValidationEvents: function() {
            ...
            if (this.$element.is("select")) { t += (new RegExp("change", "i")).test(t) ? "" : " change" }
        ...
        eventValidation: function(e) {
            var t = this.getVal();
            if (e.type === "keyup" && !/keyup/i.test(this.options.trigger) && !this.validatedOnce) { return true }
            if (e.type === "change" && !/change/i.test(this.options.trigger) && !this.validatedOnce) { return true }
            if (!this.isRadioOrCheckbox && this.getLength(t) < this.options.validationMinlength && !this.validatedOnce) { return true }
            this.validate()
        },
        getLength: function(e) { if (!e || !e.hasOwnProperty("length")) return 0; return e.length },
        isValid: function() { return this.validate(false) },
        hasConstraints: function() { for (var e in this.constraints) { return true } return false },
        validate: function(e) {
            var t = this.getVal(),
                n = null;
            if (!this.hasConstraints()) { return null }
            if (this.options.listeners.onFieldValidate(this.element, this) || "" === t && !this.isRequired) { this.reset(); return null }
            if (!this.needsValidation(t)) { return this.valid }
            n = this.applyValidators();
            if ("undefined" !== typeof e ? e : this.options.showErrors) { this.manageValidationResult() }
            return n
        },
        needsValidation: function(e) {
            if (!this.options.validateIfUnchanged && this.valid !== null && this.val === e && this.validatedOnce) { return false }
            this.val = e;
        ...
        applyValidators: function() {
            ...
            for (var t in this.constraints) {
                ...
                if (false === n) {
                    ...
                    e = false !== e;
                    if (false === this.options.listeners.onFieldSuccess(this.element, this.constraints, this)) { e = false }
                }
            }
            return e
        },
        manageValidationResult: function() {
            ...
            if (true === this.valid) {
                ...
                return true
            } else if (false === this.valid) { this.errorClassHandler.removeClass(this.options.successClass).addClass(this.options.errorClass); return false }
            if (this.ulError && e(this.ulError).children().length === 0) { this.removeErrors() }
            return t
        },
        ...
        removeError: function(t) {
            var n = this.ulError + " ." + t,
                r = this;
            this.options.animate ? e(n).fadeOut(this.options.animateDuration, function() { e(this).remove(); if (r.ulError && e(r.ulError).children().length === 0) { r.removeErrors() } }) : e(n).remove()
        },
        addError: function(t) {
            for (var n in t) {
        ...
        removeErrors: function() { this.options.animate ? e(this.ulError).fadeOut(this.options.animateDuration, function() { e(this).remove() }) : e(this.ulError).remove() },
        reset: function() {
            this.valid = null;
            this.removeErrors();
            this.validatedOnce = false;
        ...
        manageError: function(t) {
            if (!e(this.ulError).length) { this.manageErrorContainer() }
            if ("required" === t.name && null !== this.getVal() && this.getVal().length > 0) { return } else if (this.isRequired && "required" !== t.name && (null === this.getVal() || 0 === this.getVal().length)) { return }
            var n = t.name,
        ...
        manageErrorContainer: function() {
            ...
            if ("undefined" !== typeof t) { e(t).append(n); return }!this.isRadioOrCheckbox ? this.$element.after(n) : this.$element.parent().after(n)
        },
        addListener: function(e) { for (var t in e) { this.options.listeners[t] = e[t] } },
        destroy: function() {
    ...
    r.prototype = {
        ...
        inherit: function(e, t) { var r = new n(e, t, "ParsleyFieldMultiple"); for (var i in r) { if ("undefined" === typeof this[i]) { this[i] = r[i] } } },
        getName: function() { if (this.group) { return "parsley-" + this.group } if ("undefined" === typeof this.$element.attr("name")) { throw "A radio / checkbox input must have a data-group attribute or a name to be Parsley validated !" } return "parsley-" + this.$element.attr("name").replace(/(:|\.|\[|\])/g, "") },
        getVal: function() {
            if (this.isRadio) { return e(this.siblings + ":checked").val() || "" }
            if (this.isCheckbox) {
                var t = [];
                e(this.siblings + ":checked").each(function() { t.push(e(this).val()) });
                return t
            }
        },
        bindValidationEvents: function() {
            ...
            e(this.siblings).each(function() { e(this).on(n.split(" ").join("." + t.type + " "), false, e.proxy(t.eventValidation, t)) })
        }
    };
    var i = function(e, t, n) { this.init(e, t, n || "parsleyForm") };
    i.prototype = {
        constructor: i,
        init: function(t, n, r) {
            this.type = r;
            ...
            this.options = n;
            var i = this;
            this.$element.find(n.inputs).each(function() { i.addItem(this) });
            this.$element.on("submit." + this.type, false, e.proxy(this.validate, this))
        },
        addListener: function(e) { for (var t in e) { if ((new RegExp("Field")).test(t)) { for (var n = 0; n < this.items.length; n++) { this.items[n].addListener(e) } } else { this.options.listeners[t] = e[t] } } },
        addItem: function(t) {
            if (e(t).is(this.options.excluded)) { return false }
        ...
        validate: function(e) {
            ...
            for (var n = 0; n < this.items.length; n++) { if ("undefined" !== typeof this.items[n] && false === this.items[n].validate()) { t = false; if (!this.focusedField && "first" === this.options.focus || "last" === this.options.focus) { this.focusedField = this.items[n].$element } } }
            if (this.focusedField && !t) { this.focusedField.focus() }
            var r = this.options.listeners.onFormSubmit(t, e, this);
            if ("undefined" !== typeof r) { return r }
            return t
        },
        isValid: function() { for (var e = 0; e < this.items.length; e++) { if (false === this.items[e].isValid()) { return false } } return true },
        removeErrors: function() { for (var e = 0; e < this.items.length; e++) { this.items[e].parsley("reset") } },
        destroy: function() {
            for (var e = 0; e < this.items.length; e++) { this.items[e].destroy() }
            this.$element.off("." + this.type).removeData(this.type)
        },
        reset: function() { for (var e = 0; e < this.items.length; e++) { this.items[e].reset() } }
    };
